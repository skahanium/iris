...
const localEvidence: SessionEvidenceDetailRecord = {
  id: 1,
  sessionId: 10,
  citationIndex: 1,
  citationLabel: "[C1]",
  ...
  detailStatus: "source_available",
  createdAt: "2026-06-22T00:00:00Z",
};

const webEvidence: SessionEvidenceDetailRecord = {
  id: 2,
  sessionId: 10,
  citationIndex: 2,
  citationLabel: "[C2]",
...
describe("EvidenceDetailArtifactView", () => {
  ...
  it("renders evidence and conflicts without provider process details", () => {
    ...
    expect(container.textContent).toContain("source_available");
