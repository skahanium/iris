...
export const SPLIT_QUEUE = {
  ...
  "src-tauri/src/ai_runtime/web_evidence_broker.rs": 3900,
  ...
  "src-tauri/src/ai_runtime/mcp_external_tools.rs": 2600,
  ...
  "src-tauri/src/ai_runtime/agent_tool_loop.rs": 2100,
};
