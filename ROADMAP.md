...
当前视觉系统刷新目标为 **Iris Rail 完整界面系统**：常驻品牌轨道、Rail Segments Tab、沉静编辑画布、边缘目录轨、AI 协作侧车、任务舱 Overlay 与管理中心。完整设计见 [Iris Rail 完整界面系统刷新设计](docs/superpowers/specs/2026-06-09-iris-rail-refresh-design.md)。
...
- 居中任务浮层系统（`IrisOverlay`）：compact / command / management / wide / graph；管理型设置进入顶部标签式 `ManagementCenterPanel`
