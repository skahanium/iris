ALTER TABLE llm_model_registry RENAME TO llm_model_registry_without_slots;
...
SELECT
    provider_id, model_id, display_name, source, stale, first_seen_at,
    last_seen_at, last_refreshed_at, text_verified_at, vision_verified_at, '[]'
FROM llm_model_registry_without_slots;

DROP TABLE llm_model_registry_without_slots;
