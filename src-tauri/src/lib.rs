...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai_commands::skills_prepare_workspace,
            ...
            commands::ai_commands::mcp_server_catalog_upsert,
            commands::ai_commands::mcp_runtime_profile_upsert,
            commands::ai_commands::mcp_runtime_profiles_list,
            commands::ai_commands::mcp_runtime_profile_toggle,
