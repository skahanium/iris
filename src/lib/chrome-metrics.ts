 ...
 */
export const DEFAULT_TITLEBAR_HEIGHT_PX = 40;
export const MACOS_TITLEBAR_HEIGHT_PX = 32;
export const MACOS_TRAFFIC_INSET_PX = 72;
...
export function applyDesktopChromeMetricsToDocument(
  ...
  if (metrics.trafficInsetLogical > 0) {
    root.style.setProperty(
