...
export type AssistantRunErrorCode =
  ...
  | "agent_run_continuation_lock_failed"
  | "agent_run_control_not_available"
  | "agent_run_terminal_state"
  | "agent_run_classified_domain_not_supported"
  | "agent_run_evidence_lock_failed"
  | "agent_run_invalid_budget_policy"
  | "agent_run_invalid_event"
  | "agent_run_local_evidence_invalid"
  | "agent_run_invalid_explicit_action"
  | "agent_run_classified_history_disabled"
  | "agent_run_checkpoint_stage_conflict"
  | "agent_run_accepted_event_missing"
  | "agent_run_final_submission_invalid"
  | "agent_run_write_target_violation"
  | "agent_run_invalid_document_policy"
  | "agent_run_checkpoint_invalid_schema"
  | "agent_run_invalid_final_output"
  | "agent_run_confirmation_pending"
  | "agent_run_confirmation_missing"
