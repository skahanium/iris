...
import {
  appUpdateMessageText,
  embeddingFailureDetail,
  isAiManagementDetail,
  isNotesManagementDetail,
  type AiManagementDetail,
  type NotesManagementDetail,
  updateProgressText,
  updateStatusText,
} from "./managementCenterHelpers";
    ...
    <SectionShell title="总览" detail="Iris 的当前运行状态和系统边界。">
      ...
      <PanelSection title="系统边界">
        ...
        <SettingRow
          ...
          detail={
            <>
              版本 1.2.21 · GNU Affero General Public License v3.0 · Source:
