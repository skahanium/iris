...
export type { McpCredentialSave } from "./mcpProfileParsers";

import {
  argsTextToArray,
  checkLabelText,
  checkStatusText,
  credentialRowsToJson,
  editableTransportKind,
  mappingStatusText,
  mappingToolName,
  parseCredentialRows,
  parseHttpsConfig,
  parseStdioConfig,
  plainEnvRowsFromPreset,
  plainEnvRowsToRecord,
  presetIdFromProvider,
  rowsFromPreset,
  statusText,
  transportLabel,
  type CredentialRefRow,
  type McpCredentialSave,
  type McpProfileCardProps,
  type PlainEnvRow,
} from "./mcpProfileParsers";

import { McpProfileListCard } from "./McpProfileListCard";
  ...
  if (surface === "list") {
    return (
      <McpProfileListCard
        ...
        saving={saving}
        canMoveSearchRouteUp={canMoveSearchRouteUp}
        canMoveSearchRouteDown={canMoveSearchRouteDown}
        onSelect={onSelect}
        onMoveSearchRoute={onMoveSearchRoute}
      />
    );
  }
