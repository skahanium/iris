...
| 渐进联网                 | 已知缺陷 | 重构               | [`run_intake.rs`](../../src-tauri/src/ai_runtime/run_intake.rs)                                                                                                                                                               | `hr1_ordinary_external_questions_still_record_the_webpreferred_gap` 为 HR-2 目标夹具；严格 URL/金融/法规边界保持绿色                                                                | INC-HR-004/005 | HR-1/2 |
...
| 普通缺参                 | 已知缺陷 | 自然对话           | [`normal_run_service.rs`](../../src-tauri/src/ai_runtime/normal_run_service.rs)                                                                                                                                               | `production_missing_city_waits_for_input_and_resumes_the_same_run` 只证明旧事务恢复；`hr1_ordinary_missing_context_still_pauses_the_run_for_structured_input` 为 HR-4 目标夹具      | INC-HR-001     | HR-1/4 |
