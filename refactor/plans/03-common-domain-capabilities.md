...
**Status:** Planned；对应阶段 8 的 `CAP-001`，不属于阶段 5–7 核心缺陷的完成条件。测试通过并更新附录 A、B 后，才可同步 `ARCHITECTURE.md` 和 IPC 事实文档。
...
- [ ] **Step 1: 写 migration up/down 失败测试**
...
- [ ] **Step 1: 写 catalog 与 surface 失败测试**
