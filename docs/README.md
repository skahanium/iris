...
- AI runtime 当前边界与 context cache 见 [ARCHITECTURE.md](../ARCHITECTURE.md#ai-runtime-v110-模块边界)。
- 深拆/性能审查记录见 [audits/2026-06-11-project-review-v1.1.0.md](./audits/2026-06-11-project-review-v1.1.0.md)。
- 性能基准命令：`cargo bench --manifest-path src-tauri/Cargo.toml --bench ai_benchmarks`。

---

## 历史文档

v0.1.0–v0.5.2 期间的 Epic、施工计划、设计 spec、品牌规划与 Notion 参考摘要已归档至 [docs/history/](./history/)。这些文件保留决策背景，可能与当前实现不一致，不作为当前事实来源；界面以 [design-system.md](./design-system.md) 为准。

`docs/history/plans/`、`docs/superpowers/plans/` 与 `docs/superpowers/specs/` 是施工过程资料。引用其中内容前必须先核对 README、ROADMAP、ARCHITECTURE 与当前代码。
